...
INSERT INTO products(name, category_id, description, price, stock) VALUES
('John Deere 6155M', 1, '155 lóerős univerzális traktor.', 48990000.00, 3),
('New Holland T7.315', 1, '315 lóerős nagy teljesítményű traktor.', 68900000.00, 2),
('CLAAS LEXION 7700', 1, 'Hybrid rendszerű kombájn.', 139900000.00, 1),
('Fendt 724 Vario', 1, '240 lóerős prémium kategóriás traktor.', 72900000.00, 1),
('Gardena Comfort permetező', 2, '5 literes kézi permetező.', 12990.00, 15),
('Hunter Pro-HC vezérlő', 3, 'WiFi-s öntözésvezérlő rendszer.', 89990.00, 6),
('Rain Bird 5000 szórófej', 3, 'Professzionális rotoros szórófej.', 7990.00, 20);
